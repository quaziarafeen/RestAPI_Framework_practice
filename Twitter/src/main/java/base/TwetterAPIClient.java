...
public class TwetterAPIClient {
    ...
    public TwetterAPIClient() {
        this.baseUri = "https://api.twitter.com/1.1";
        this.properties = new Properties();
        this.inputStream = null;
        try {
            // path of the properties file
            this.inputStream = new FileInputStream("C:\\Users\\Quazi\\IdeaProjects\\RestAPIAutomationFramework_WeekDays_SeleniumDecember2019\\Twitter\\src\\main\\java\\secret.properties");
